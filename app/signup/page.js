    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-4 bg-gray-900 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-0 left-0 w-96 h-96 bg-purple-600/30 rounded-full blur-3xl opacity-50 animate-blob"></div>
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-600/30 rounded-full blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
            ...
            <div className="relative z-10 w-full max-w-5xl grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="hidden md:block p-8">
                    ...
                    <h1 className="text-5xl font-bold text-white leading-tight mb-6">
                        ...
                        <span className="text-blue-400">Academic Success</span>
                    </h1>
                    <p className="text-gray-400 text-lg mb-8 max-w-md">
                        Join thousands of students who are mastering their study schedule with AI-powered planning.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-white/5 rounded-xl border border-white/10 backdrop-blur-sm">
                            <h3 className="font-semibold text-white mb-1">AI-Powered</h3>
                            <p className="text-sm text-gray-400">Smart study schedules tailored to you</p>
                        </div>
                        <div className="p-4 bg-white/5 rounded-xl border border-white/10 backdrop-blur-sm">
                            <h3 className="font-semibold text-white mb-1">Track Progress</h3>
                            <p className="text-sm text-gray-400">Visual analytics of your growth</p>
                        </div>
                    </div>
                </div>
